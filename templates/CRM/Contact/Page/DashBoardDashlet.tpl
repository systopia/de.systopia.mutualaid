...
<ul id="column-0" class="column ui-sortable" style="width: 100%;">
	...
	<li class="widget widget-getting-started" id="widget-1">  
		<div class="widget-wrapper">  <div class="widget-controls"><h3 class="widget-header ui-sortable-handle">&nbsp;CiviCRM Mutual Aid Dashboard</h3></div> 
		<div class="widget-content" style="display: block;">
			<div id="civicrm-getting-started">
				...
				<br />
					...
					<h3>Status <i class="crm-i fa-bar-chart float-right"></i></h3>
			...
			<!--<tr><td width="8" style="opacity: 0.35"><strong>X</strong></td><td><a href="#" target="_blank">Offers</a></td></tr>
			<tr><td width="8" style="opacity: 0.35"><strong>Y</strong></td><td><a href="#" target="_blank">Requests</a></td></tr>
			<tr><td width="8" style="opacity: 0.35"><strong>Z</strong></td><td><a href="#" target="_blank">Matched requests</a></td></tr>
			<tr><td width="8"><strong style="color: #942a25;">18</strong></td><td><a href="#" target="_blank">Unmatched requests</a></td></tr>-->
			</tbody></table></h3>
